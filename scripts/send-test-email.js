...
const SUBJECT = 'Exchange Server Test E-postası';
...
const exchangeConfig = {
  ...
  auth: {
    user: 'kentkonut\\noskay',  // Domain\kullanıcı formatında
    pass: '0renegade***'        // Kullanıcı şifresi
  },
  tls: {
...
const emailOptions = {
  ...
  to: TO_EMAIL,
  subject: SUBJECT,
  text: 'Bu bir test e-postasıdır. Exchange Server 2019 üzerinden Node.js ile gönderilmiştir.',
  html: `
  <!DOCTYPE html>
  <html>
  <head>
...
async function sendEmail() {
  console.log('Exchange Server E-posta Gönderme Testi');
  ...
  console.log(`Auth User: ${exchangeConfig.auth.user}`);
  console.log('='.repeat(50));
